        ...
        setTimeout(async () => {
          ...
          if (result?.ok) {
            ...
            window.location.href =
              "/auth/signin?message=Please sign in with your new account";
          }
        }, 1500);
      } else {
        ...
        <form onSubmit={handleEmailSignUp} className="space-y-4">
          ...
          <div>
            ...
            <select
              ...
              onChange={handleInputChange}
              className="relative block w-full px-3 py-3 border border-gray-300 text-gray-900 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-sm"
            >
              <option value="seeker">Find a room (Seeker)</option>
              <option value="owner">Rent out my property (Owner)</option>
              <option value="both">Both find and rent out rooms</option>
            </select>
          </div>
          ...
          <div className="relative">
            ...
            <input
              ...
              onChange={handleInputChange}
              className="relative block w-full px-3 py-3 pr-10 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-sm"
